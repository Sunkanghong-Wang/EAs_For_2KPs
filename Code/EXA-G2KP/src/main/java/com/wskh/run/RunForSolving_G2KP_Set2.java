...
import com.wskh.solvers.GTKP.GTKP_UnSafe_Solver_NoLBD;
...
public class RunForSolving_G2KP_Set2 {
...
//                if (!file.getName().equals("Class_03_060_25.ins2D")) continue;
                ...
                int delta1 = Integer.parseInt(fileNameSplit[4]);
                int delta2 = Integer.parseInt(fileNameSplit[5]);
                int delta3 = Integer.parseInt(fileNameSplit[6]);
                ...
                while ((input = bufferedReader.readLine()) != null) {
                    if (row == 0) {
                        ...
                        if (input.contains(" ")) {
                            ...
                            itemList.add(new LongValue_Item(itemList.size(), itemList.size(), w, h, s, v, v / s));
...
//                    throw new RuntimeException(objValue + " != " + solver.LB);
                ...
                if (csv != null) {
                    Object[] objects = new Object[]{
                            className, id, delta1, delta2, delta3, W, H, n, conflictList.size(), bindList.size(), srCutList.size(),
...
//        TimeUtil.TimeLimit = 1000L;
        ...
        csv.write(("Class,id,delta1(%),delta2(%),delta3(%),W,H,n,|E_d|,|E_s|,|SR|," +
        ...
        // 预热
//        for (int i = 0; i < 400; i++) {
//            test(null, "../../Instances/G2KP/Classic/Set2");
//        }

        test(csv, "../../Instances/G2KP/Classic/Set2");
//        test(csv, "../../Instances/G2KP/Newly/Set2");
